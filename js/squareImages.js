define(["js/properties"], function(properties) {
	...
	return {
		...
		imageValuesEquivalent: function imageValuesEquivalent(imageValue1, imageValue2) {
		...
		nextImage: function nextImage(imageId) {
			return (imageId+1) % properties.NUMBER_CHANGEABLE_IMAGES;
		},

		pinnableImage: function pinnableImage(imageId) {
